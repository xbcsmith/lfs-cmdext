...
`
	...
	app, err := ExtractApplication(doc)
	assert.Assert(t, is.Nil(err))
	assert.Equal(t, app.Name, "freetype", "Expected name to be freetype")
	assert.Equal(t, app.Version, "2.10.1", "Expected version to be 2.10.1")
	fmt.Printf("APPLICATION NAME : %s\n", app.Name)
	fmt.Printf("APPLICATION VERSION : %s\n", app.Version)
	fmt.Printf("APPLICATION DESCRIPTION : %s\n", app.Description)
	deps, err := ExtractDependencies(doc)
...
// TestCreatePackageInformation func takes no input and returns t *testing.T
func TestCreatePackageInformation(t *testing.T) {
	htmlPkg := `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
    "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
  ...
  <body class="lfs" id="lfs-9.0">
    <div class="navheader">
      ...
      <ul>
        <li class="prev">
          <a accesskey="p" href="perl.html" title="Perl-5.30.0">Prev</a>
          <p>
            Perl-5.30.0
          </p>
        </li>
        ...
        <li class="home">
          <a accesskey="h" href="../index.html" title=
          "Linux From Scratch - Version 9.0 ">Home</a>
        </li>
      </ul>
    </div>
    <div class="wrap" lang="en" xml:lang="en">
      <h1 class="sect1">
        <a id="ch-tools-Python" name="ch-tools-Python"></a>5.30. Python-3.7.4
      </h1>
      <div class="package" lang="en" xml:lang="en">
        <p>
        ...
        <div class="segmentedlist">
          <div class="seglistitem">
            ...
            <div class="seg">
              ...
              <span class="segbody">381 MB</span>
            </div>
          </div>
        </div>
      </div>
      <div class="installation" lang="en" xml:lang="en">
        ...
        <div class="admon note">
          ...
          <p>
            There are two package files whose name starts with <span class=
            "quote">&ldquo;<span class="quote">python</span>&rdquo;</span>.
            The one to extract from is <code class=
            "filename">Python-3.7.4.tar.xz</code> (notice the uppercase first
            letter).
          </p>
        </div>
        <p>
          ...
          "filename">/usr/lib</code> directories. To prevent them from being
          used, issue:
        </p>
        <pre class="userinput">
<kbd class=
...
<kbd class="command">./configure --prefix=/tools --without-ensurepip</kbd>
        ...
        <div class="variablelist">
          ...
          <dl class="variablelist">
            ...
            <dd>
              <p>
                This switch disables the Python package installer, which is
...
<kbd class="command">make</kbd>
        ...
        <p>
          Compilation is now complete. The test suite requires TK and and X
          Windows and cannot be run at this time.
        </p>
        <p>
          Install the package:
        </p>
...
<kbd class="command">make install</kbd>
      ...
      <div class="content" lang="en" xml:lang="en">
        <p>
          ...
          "../chapter06/Python.html#contents-python" title=
